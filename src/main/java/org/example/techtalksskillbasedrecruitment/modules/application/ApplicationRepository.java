...
public interface ApplicationRepository extends JpaRepository<Application,Integer> {
    ...
    @Query("""
    SELECT new org.example.techtalksskillbasedrecruitment.modules.application.dto.response.MyApplicationsResponse(
        a.applicationId, 
        a.status, 
        j.title, 
        j.description, 
...
""")
    ...
    @Query("""
        SELECT new org.example.techtalksskillbasedrecruitment.modules.application.dto.response.CandidateAppsResponse(
            a.applicationId,
            a.status,
            a.appliedAt,
            cp.location,
