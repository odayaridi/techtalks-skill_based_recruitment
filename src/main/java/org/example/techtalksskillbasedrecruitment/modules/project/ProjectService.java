...
public class ProjectService {
    ...
    public List<ProjectResponse> getAllProjectsService(Integer candidateId){
        CandidateProfile candidateProfile = this.candidateProfileRepository.findById(candidateId).orElseThrow(()->new ResourceNotFoundException("Invalid Candidate Id. Cannot retrieve candidate projects"));
        List <Project> projects = this.projectRepository.findByCandidate(candidateProfile);
